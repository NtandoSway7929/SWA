...
create table if not exists public.social_posts (
    ...
    platform text not null default 'Instagram' check (platform in ('Instagram','Facebook','TikTok','Multi-platform')),
...
create index if not exists social_metrics_account_date_idx on public.social_metrics(social_account_id, metric_date desc);
